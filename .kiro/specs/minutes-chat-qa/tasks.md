...
- [ ] 2.1 ChatButtonコンポーネントを作成
  - `frontend/components/chat-button.tsx`を作成
  - 固定位置（右下）に配置
  - クリックでチャットモーダルを開く
  - _Requirements: 1.1, 1.2_

- [ ] 2.2 ChatModalコンポーネントを作成
