...
- [x] 15. エラーハンドリングとログの統合




  - [x] 15.1 統一されたエラーハンドリングを実装する
...
- [x] 16. 統合テストの作成
  ...
  - [x] 16.2 Step Functionsワークフローテストを作成する
